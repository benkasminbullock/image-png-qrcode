...
There is an example script F<qrpng.cgi> in F<examples> which makes a
PNG from a user's input.
...
developed for a platform called the Arduino by Tom
Zerucha. Image::PNG::QRCode is a fork of this project.
